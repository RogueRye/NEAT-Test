...
public class Boomerang2 : MonoBehaviour, IAgentTester
{
    /// <summary>
    ...
    public void UpdateNet()
    {
        ...
        deltaVectorAngle = deltaVectorAngle / 180f;

        inputs[0] = deltaVectorAngle;
        //Debug.Log("from go: " + gameObject.name + " " + deltaVectorAngle);
